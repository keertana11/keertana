...
<body>
	<div class="productsbox">
		...
		<form action="admin_product_edit_conn.php" method="post">
			<p>
           ...
           <p>
				...
				<input type="int" name="featured" id="featured" required="">
			</p>

			
			
			
			<input type="submit" value="Edit" class="btn btn-success mt-5">
