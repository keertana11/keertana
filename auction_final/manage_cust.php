...
<!--main content of featured products-->
  ...
  <div class="bg">
    <h2 class="text-center text-light font-weight-bold m-3 ">CUSTOMERS</h2>
    <div class="container d-flex flex-column">
	  ...
	  <button class="btn btn-danger "  onclick="window.location.href='admin_customer_account_edit.php'">EDIT</button>
	  <button class="btn btn-warning ml-3"  onclick="window.location.href='admin_customer_account_delete.php'">DELETE </button>
	  </div>    </div>
