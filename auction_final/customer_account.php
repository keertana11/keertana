...
<!--main content of featured products-->
  ...
  <div class="bg">
    ...
    while ($product = mysqli_fetch_array($featured)) : ?>
        ...
        <button class="btn btn-danger "  onclick="window.location.href='customer_account_edit.php'">Edit</button>
		<button class="btn btn-warning ml-4"  onclick="window.location.href='customer_account_delete.php'">Delete Account</button>
      </div>
    </div>
